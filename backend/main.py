"""
Python Code Visualizer - Backend
"""
import sys
import os

# Try loading from environment variable first (for Vercel/Render)
...
app = FastAPI(
    ...
    description="Explain and visualize Python code execution",
    version="1.0.0"
)
    ...
    try:
        response = httpx.post(
            ...
            headers={
                ...
                "HTTP-Referer": "https://python-code-visualizer.vercel.app",
                "X-Title": "Python Code Visualizer"
            },
            json={
